  ...
  return (
    <>
      ...
      <div style={{ position: 'relative', zIndex: 10 }}>
        ...
        {/* ── Connect section ────────────────────────────────── */}
        <div style={{ padding: '60px 0 0 0', position: 'relative' }}>
          {/* "Connect" label — same position as Projects label */}
          <div style={{
            position: 'absolute',
            left: '150px',
            top: '60px',
          ...
          {/* Logos — shifted slightly left of the 732px grid */}
          <div style={{
            display: 'flex',
            gap: '16px',
            paddingLeft: 'calc(50% - 366px - -4px)',
          }}>
            <motion.a
